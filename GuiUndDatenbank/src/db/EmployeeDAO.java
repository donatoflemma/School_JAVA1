...
//	
//	public DoubleArrayTable Table(String lookingFor) {//String classPane,List checkb
//		Connection conn = DatabaseConnection.connect();
	...
	public DoubleArrayTable Table(String lookingFor,List checkb) {//String classPane,List checkb
		...
		if(conn != null) {
			...
			try {
				...
				if (lookingFor.equalsIgnoreCase("all" ) ) { //  per il nome  
...
//						rs = stmt3.executeQuery();// non passa niente perche PrepareStatement prepara tutto
//						System.out.print(sql);
//						System.out.print("tutto dove nome ");
//						}
//					else {
						//+ String.join(", ", fields) +
